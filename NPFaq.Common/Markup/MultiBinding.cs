...
namespace NPFaq.Common.Markup
{
    ...
    {       
        ...
        public static MultiBinding GetStyleBinding(DependencyObject obj)
        {
            return (MultiBinding)obj.GetValue(StyleBindingProperty);
        }
        ...
        public static readonly DependencyProperty StyleBindingProperty =
            DependencyProperty.RegisterAttached("StyleBinding", typeof(MultiBinding), typeof(MultiBinding), new PropertyMetadata(null, OnMultiBindingChanged));
